...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6" data-aos="fade-up">
    ...
    {{-- Pagination --}}
    <div class="mt-6 flex justify-center" data-aos="fade-up" data-aos-delay="300">
        {{ $bookings->links() }}
    </div>
@endsection
