        ...
        <div
            ...
            <div class="md:w-1/2 p-8 fade-right animate-on-scroll">
                ...
                <form method="POST" action="{{ route('password.update') }}" class="space-y-4">
                    ...
                    <input type="text" name="whatsapp_number" value="{{ $whatsapp_number ?? old('whatsapp_number') }}"
                    ...
                    <button type="submit" class="w-full bg-green-600 text-white p-3 rounded hover:bg-green-700 transition">
                        Reset Password
                    </button>
                </form>
            </div>
